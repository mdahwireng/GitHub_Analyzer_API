...
if os.path.exists("/home/mdahwireng/Documents/Github/tenx/GitHub_Analyzer_API/.env/env_var.json"):
...
def run_api()-> None:
    """
    This function is used to run the flask app.
    """
    ...
    def single_repos_meta_single_repos_pyanalysis(user, token, repo_name)->json:
        """
        Takes username, github generated token and name of repo and returns json of details of python code analis in 
        repository
        ...
        if resp_status_code == 200:
            ...
            return jsonify({"repo_meta":{"error":resp.json()["errors"][0]["message"]}, "analysis_results":{"error":resp.json()["errors"][0]["message"]}})
